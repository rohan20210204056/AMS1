...
<body>
    <div class="alumnimain">
        ...
        <div class="content">
            Develop a fully connected, strong alumni community for all university.<br>
        </div>
        <div class="subheading">
            <b>MISSION</b>
        </div>
        <div class="content">
            Promote alumni relationships, develop student engagement, and allow student-alumni interactions to benefit each universities.
        ...
        <div class="content">
            ...
            Director <br>
            Alumni Council <br>
            Ahsaullah university of Science and Technology <br>
            </p>
        </div>
</div>
</body>
